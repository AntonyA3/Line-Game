...
//<*Entity*> repo src\line_model.json
//<*Entity*> repo src\grid.json
...
{    
    ...
    void updateStateString(){
        ...
        {
        case State::Pressed:
            state_string = std::string("Pressed");
            break;
        case State::Down:
            state_string = std::string("Down");
            break;
        case State::Released:
            state_string = std::string("Released");
            break;
        case State::Up:
            state_string = std::string("Up");
            break;
        }
    }
    public:
    ...
    void init(){
        this->state = State::Up;
        this->state_string = std::string("Up");
    }
...
//   <*Entity*> imguilog src\grid.json

//   <*Entity*> imguilog src\camera.json


//   <*Entity*> imguilog src\cursor.json

//   <*Entity*> imguilog src\player.json
